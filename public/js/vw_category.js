...
var datatable = $('html #emp_list').DataTable({ 
    ...
    function addCategories(dataset){ 
        ...
        $.ajax({
            url: baseUrl()+'api/products/add_categories',
            type: 'POST',
            dataType: 'json',
            data: dataset,
	...
	function getCategories(){
		$.ajax({
			url: baseUrl()+'api/products/get_categories',
			type: 'POST',
			dataType: 'json',
			success: function(data){
    ...
    function deleteCategories(id){
        ...
        $.ajax({
            url: baseUrl()+'api/products/delete_categories',
            type: 'POST',
            dataType: 'json',
            data: {id:id},
            success: function(data){
    ...
    function updateCategories(dataset){
        ...
        $.ajax({
            url: baseUrl()+'api/products/update_categories',
            type: 'POST',
            dataType: 'json',
            data: dataset,
            success: function(data){
    ...
    function getSelectedCategories(id){
        ...
        if (ajaxStart===0) {
            ajaxStart = 1;
            $.ajax({
                url: baseUrl()+'api/products/search_categories',
                type: 'POST',
                dataType: 'json',
                data: {id:id},
                success: function(data){
